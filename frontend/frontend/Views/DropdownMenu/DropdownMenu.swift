...
struct DropdownMenu: View {
    ...
    var body: some View {
        ...
        Text(selectedOption == nil ? placeholder : selectedOption!.displayText)
					.fontWeight(.black)
      ...
      RoundedRectangle(cornerRadius: 20)
		...
		.padding(
			...
			? CGFloat(self.options.count * 32) > 300
			    ...
			    ? 300 + 55 // max height + more padding to set space between borders and text
			    // IF false, then calculate options size and set padding
			    : CGFloat(self.options.count * 32) + 55
